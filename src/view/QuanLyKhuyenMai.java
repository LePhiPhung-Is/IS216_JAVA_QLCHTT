    ...
    static class KhuyenMaiForm extends JDialog {
        ...
        private void initForm(KhuyenMai km) {
            ...
            spnSoLuot = new JSpinner(new SpinnerNumberModel(
                    isSua ? (int) km.getSoLuotDung() : 100, 0, 999999, 10)); // Ép tạm int cho Spinner
        ...
        private void luuDuLieu() {
            ...
            long   soLuot         = ((Integer) spnSoLuot.getValue()).longValue(); // Lấy giá trị ra ép kiểu long
